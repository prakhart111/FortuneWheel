...
const HomePage = () => {
  return (
    ...
    <img src={bg2} className="absolute bottom-0" /> */}
        <img src={staticSpinner} className="self-center w-56 md:w-0 absolute -top-12 md:static" />
    <div className="flex flex-col sm:flex-row absolute gap-12">
    <img src={staticSpinner} className="self-center w-0 md:w-96 absolute -top-12 md:static" />
        
        <div className='sm:ml-8 w-96 flex flex-col align-center justify-center'>
        <p className='ml-2 font-bold text-2xl md:text-3xl text-left mb-1'>This is how EngageBud</p>
