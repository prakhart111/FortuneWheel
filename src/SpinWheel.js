  ...
  return (
    ...
    />
      ...
      <div className="App-header z-10">
        ...
        <img src={pin} className={`absolute z-12 w-12 ${spin && "spinner-logo"}`} />
        <button 
        className='absolute text-white bottom-44 btn m-2 bg-button font-bold p-2 px-8 text-xl rounded-full cursor-pointer'
        onClick={()=>{
            let item = spinIt();
            setSpin(true);
            console.log(item);
