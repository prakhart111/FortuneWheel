...
const copy = () => {
  ...
  return (
    ...
    <img src={bg2} className="absolute bottom-0" /> */}
        <img src={staticSpinner} className="self-center w-56 md:w-0 absolute -top-12 sm:static" />
    <div className="flex flex-col sm:flex-row absolute items-center align-center">
    <img src={staticSpinner} className="self-center w-0 md:w-96 absolute -top-12 sm:static" />
